		...
		<div id="layoutSidenav_content">
			<main>
				...
				<div class="insert-form">
					...
					<form  method="post">
						<label for="id">Id : </label> <input value="${category.id}" type="text" id="name"
							name="id" disabled><br>
						<br>
						<label for="name">Name:</label> <input value="${category.name}" type="text" id="name"
							name="name"><br>
						<br> <label for="image">Image:</label> <input value = "${category.image}" type="text"
