										...
										<tr>
											...
											<td><c:choose>
													<c:when test="${i.status == 1}">
														<form action="/Nhom11/admin/suppliers/delete?id=${ i.id.toString() }" method="post"> <button type="submit">Delete</button> </form>
													</c:when>
													<c:when test="${i.status == 0}">
														<form action="/Nhom11/admin/suppliers/restore?id=${ i.id.toString() }" method="post"> <button type="submit">Restore</button> </form>
													</c:when>
												</c:choose></td>
										</tr>
									</c:forEach>
