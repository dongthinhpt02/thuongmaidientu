			...
			<main>
				...
				<div class="insert-form">
					...
					<form method="post">
						...
						<br> <label for="unitPrice">Giá</label> <input
							type="number" id="unitPrice" name="unitPrice" step="0.01"
							required><br>
						<br> <label for="quantityLeft">Số lượng nhập</label> <input
							type="number" id="quantityLeft" name="quantityLeft" required><br>
						<br> <label for="description">Mô tả</label><br>
						<textarea id="description" name="description" rows="4" cols="50"></textarea>
						<br>
						<br> <label for="image">Ảnh</label> <input type="text"
						...
						<br> <button type="submit" value="Submit"> Thêm </button>
					</form>
				</div>
			</main>
