...
public class UpdateProductController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/views/admin/product/updateproduct.jsp").forward(req, resp);
	}
	@Override
	...
	protected void updateProduct(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Product product = new Product(id, name, unitPrice, quantityLeft, description, image, status, supplier, category);
